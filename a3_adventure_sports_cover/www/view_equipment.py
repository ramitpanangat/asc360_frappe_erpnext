...
def get_context(context):
    ...
    equipment = get_doc("Operator Equipment", frappe.form_dict.docname)
    ...
    context.equipment_certificates = equipment.equipment_certificate
    context.staffs = equipment.equipment_staff