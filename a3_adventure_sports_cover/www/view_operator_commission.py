...
def get_context(context):
    ...
    operator_commission = get_doc("Operator Commission Payment", frappe.form_dict.docname)
    ...
    context.operator_commission = operator_commission
    context.operator_commission_payable = operator_commission.operator_commission_payable
