...
def get_context(context):
    ...
    activity = get_doc("Operator Activity","Paragliding")
    ...
    context.staffs = activity.activity_staff
    context.policies = activity.activity_policy
    context.equipments = activity.activity_equipments
